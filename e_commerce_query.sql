...
-- 2)Query the total quantity of products from store with storeid 8 in the shopping cart?
...
-- 3)Query the name and address of orders delivered on 2017-02-17?
...
-- 4)Insert the user id of sellers whose name starts with A into buyer?
insert into buyer 
...
-- 5) Update the payment state of orders to unpaid which created after year 2017 and with total amount greater than 50.?

update orders
set paymentStatus='Unpaid'
where totalAmount > 50 and year(creationtime)>=2017;

-- 6)Update the name and contact phone number of address where the provice is Quebec and city is montreal.?
update address
...
-- 7)Create view of all products whose price above average price?
...
-- 8)Create view of all products sales in 2016.?
